...
const Rules = () => {
  return (
    <div className="max-w-2xl">
      ...
      <p>To win you should complete for consecutive circles of the same color</p>
      ...
      <ol>
        ...
        <li>The turns are </li>
        <li>First player to stack 4 circles of the same color wins</li>
        <li>It's possible to stack circles vertically, horizontally, and diagonally</li>
      </ol>
